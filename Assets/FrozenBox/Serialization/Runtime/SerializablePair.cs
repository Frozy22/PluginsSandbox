...
{
    [Serializable]
    public struct SerializablePair<TKey, TValue> : IEquatable<SerializablePair<TKey, TValue>>, ISerializablePair<TKey, TValue>
    {
        public TKey Key
        {
            readonly get => _key;
        ...
        {
            return obj is SerializablePair<TKey, TValue> other && Equals(other);
        }
